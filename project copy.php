			...
			<div class="wrapper clearfix">
				...
				<div id="project-content" class="clearfix">
					...
					<div class="project-container">
						<iframe src="/circlewaves/index.html"></iframe>
					</div>
					...
					<div class="project-slider">
				        <div class="flexslider">
						  <ul class="slides">
						    ...
						    <li>
						      <iframe src="/graph/index.html"></iframe>
						    	<!--<img src="img/slides/02.jpg" alt="alt text" />--
						    </li>
						    <li>
						      <iframe width='960px' height='473px' src="/wheeloftext/index.html"></iframe>
					...
					<div class="related-projects">
						...
						<div class="related-list">
							<figure>
								...
								<a href="single.php" class="heading">Pellentesque habitant morbi</a>
							</figure>
